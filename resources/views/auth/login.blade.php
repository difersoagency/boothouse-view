            ...
            <div class=" grid grid-cols-1 lg:grid-cols-2 items-center">
                <div class="formLogin mt-[45%] lg:mt-0">
                    ...
                    <form action="{{('login')}}" class="mt-10" method="POST">
                        @csrf
                        <input type="text" class="w-full lg:w-80 px-5 rounded-3xl text-prim-dark-green bg-prim-white border-2 h-12 border-prim-brown" placeholder="Email atau Username" name="email">
                        <br>
                    ...
                    <div class="w-full lg:w-80 text-center mt-2">
                        <p class="text-prim-dark-green text-[12px]">Belum mempunyai akun? <span><a href="/register" class="font-bold underline hover:text-prim-dark-blue transition-colors">Daftar Sekarang</a></span></p>
                    </div>
                </div>
