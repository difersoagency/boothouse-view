            ...
            <div class="flex items-center justify-center h-screen">
                <div class="formLogin w-80 mx-auto my-auto">
                    ...
                    <form action="{{('login')}}" class="mt-10" method="POST">
                        ...
                        <input type="text" class="w-full lg:w-80 px-5 rounded-3xl text-prim-dark-green bg-prim-white border-2 h-12 border-prim-brown" placeholder="Konfirmasi Password Baru" name="conf-passbaru">
