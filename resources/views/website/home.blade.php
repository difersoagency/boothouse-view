    ...
    <section class="mt-[25px] md:mt-[80px] w-screen">
        <div class="w-full lg:w-[1280px] mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 lg:gap-14 px-[20px] lg:px-[80px]">
                <div class="text col-span-1 md:col-span-6">
                    <h1 class="text-[46px] text-prim-brown font-bold leading-tight">Buat Booth Berkualitas Sesuai Imajinasimu
                    </h1>
                    <p class="text-[16px] text-prim-brown mt-4">Buat booth impianmu menjadi kenyataan di BootHouse Indonesia
            ...
            <div class="tipe mt-[100px] px-[20px] lg:px-[80px]">
                <h2 class="text-prim-brown text-[36px] font-bold mb-[50px]">Tipe Booth di Boot<span
                        class="text-prim-yellow">House</span> ?</h2>
        ...
        <div class="bg-prim-yellow">
            <div class="menagapa bg-prim-yellow w-full lg:w-[1280px] mt-[120px] px-[20px] lg:px-[80px] py-[55px] mx-auto">
                <div class=" mx-auto">
                    <h2 class="text-[36px] text-center text-prim-brown font-bold">Mengapa Boot<span
                            class="text-prim-white">House</span> ?</h2>
                    <div class="list-mengapa mt-[36px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10">
                        <div class="lg:col-span-4 h-[370px] w-full bg-prim-white rounded-xl px-[27px] py-[18px]">
                            ...
                            <p class="text-[16px] text-prim-brown mt-4">Booth yang terbuat dari kontainer maupun yang
