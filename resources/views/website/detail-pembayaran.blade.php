            ...
            <div class="informasiKirim">
                ...
                <form action="" class="grid grid-cols-2 mt-7 gap-x-8 gap-y-4">
                    <div>
                        ...
                        <input type="text" name="nama-depan" id="nama-depan" class="mt-3 h-10 w-full rounded-md border-2 border-prim-brown px-3 text-prim-brown">
                    </div>
                    <div>
                        <label for="nama-belakang" class="mb-2 text-prim-brown font-bold text-[14px]">Nama Belakang</label> <br>
                        <input type="text" name="nama-belakang" id="nama-belakang" class="mt-3 h-10 rounded-md border-2 w-full border-prim-brown px-3 text-prim-brown">
                    </div>
                    <div>
                        <label for="provinsi" class="mb-2 text-prim-brown font-bold text-[14px]">Provinsi</label> <br>
                        <input type="text" name="provinsi" id="provinsi" class="mt-3 h-10 rounded-md border-2 w-full border-prim-brown px-3 text-prim-brown">
                    </div>
                    <div>
                        <label for="kota" class="mb-2 text-prim-brown font-bold text-[14px]">Kota</label> <br>
                        <input type="text" name="kota" id="kota" class="mt-3 h-10 rounded-md border-2 w-full border-prim-brown px-3 text-prim-brown">
                    </div>
                    <div class="col-span-2">
                        <label for="alamat" class="mb-2 text-prim-brown font-bold text-[14px]">Alamat Lengkap</label> <br>
                        <input type="text" name="alamat" id="alamat" class="mt-3 h-10 rounded-md border-2 w-full border-prim-brown px-3 text-prim-brown">
                    </div>
                    <div class="">
                        <label for="tel" class="mb-2 text-prim-brown font-bold text-[14px]">No.Telepon</label> <br>
                        <input type="tel" name="tel" id="tel" class="mt-3 h-10 rounded-md border-2 w-full border-prim-brown px-3 text-prim-brown">
                    </div>
                    <div></div>
                    <div class="submit-pembayaran">
                        <button type="submit" class=" mt-5 px-5 py-2 bg-prim-red rounded-md text-prim-white">Pembayaran</button>
                    </div>
                </form>
            </div>
            <div class="informasiPesanan">
                <div class="px-8 py-5 bg-prim-yellow rounded-t-md">
                    ...
                    <div class="mt-3">
                        <ul class="grid gap-6 w-full md:grid-cols-2">
                            <li>
                                ...
                                <label for="mandiri" class="inline-flex justify-between items-center px-5 py-2 w-full rounded-lg border-2 border-prim-brown bg-prim-white text-prim-brown font-bold cursor-pointer transition-all dark:hover:text-prim-white dark:border-prim-brown dark:peer-checked:text-prim-white peer-checked:bg-prim-brown peer-checked:text-blue-600 hover:text-prim-white hover:bg-prim-brown">
                                    <div class="block">
                            ...
                            <li>
                                ...
                                <label for="jasaKirim" class="inline-flex justify-between items-center text-center py-2 w-40 rounded-lg border-2 border-prim-brown bg-prim-white text-prim-brown font-bold cursor-pointer transition-all dark:hover:text-prim-white dark:border-prim-brown dark:peer-checked:text-prim-white peer-checked:bg-prim-brown peer-checked:text-blue-600 hover:text-prim-white hover:bg-prim-brown">
                    ...
                    <div class="subtotal grid grid-cols-2 mt-8 gap-y-3 items-center">
                        ...
                        <p>: <input type="number" name="dibayar" id="dibayar" class="px-2 focus:outline-none h-8 rounded-md border-2 text-prim-brown border-prim-brown"> </p>
                    </div>
                </div>
