            ...
            <div class=" grid grid-cols-1 lg:grid-cols-2 items-center">
                <div class="formLogin mt-[45%] lg:mt-0">
                    ...
                    <form action="" class="mt-10">
                        <input type="text" class="w-full lg:w-80 px-5 rounded-3xl text-prim-brown bg-prim-white border-2 h-12 border-prim-brown" placeholder="Email">
                        <br>
                        <input type="password" class="mt-6 w-full lg:w-80 px-5 rounded-3xl text-prim-brown bg-prim-white border-2 h-12 border-prim-brown" placeholder="Password">
