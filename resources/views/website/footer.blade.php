<footer class="bg-prim-dark-green">
    <div class=" w-full lg:w-[1280px] px-[20px] lg:px-[67px] py-[75px] mx-auto">
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-16 justify-between items-start ">
            <div class="col-span-2 lg:col-span-1">
                <img src="{{asset('assets/images/logo_new_2.png')}}" alt="Logo BootHouse" class="w-[150px]">
                <p class="text-[14px] text-prim-white mt-[20px]">BootHouse adalah tempat terbaik yang dapat membuat booth impian Anda menjadi nyata guna mendukung keperluan bisnis Anda dengan kualitas terbaik</p>
            </div>
            <div class="">
...
<div class="bg-prim-light-blue text-prim-dark-green w-full py-[16px]">
