        ...
        <div class="dataDiri mt-10 w-[50%] hidden">
            ...
            <form action="" class="grid grid-cols-2 mt-5">
                <div>
                    ...
                    <br>
                    <input type="text" name="email" id="email-field" class="mt-3 bg-prim-white px-5 py-2 border-2 rounded-xl border-prim-brown text-prim-dark-green" placeholder="email@gmail.com" value="youremail@gmail.com" disabled>
                    <br>
