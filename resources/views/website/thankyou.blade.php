...
@section('content')
    <section class="w-screen">
        <div class="w-full lg:w-[1280px] mx-auto text-center px-10 lg:px-[80px] py-10">
            ...
            <button
                class="mt-4 mx-auto col-span-2 px-5 py-2 hover:bg-prim-yellow rounded-full bg-prim-red transition-colors text-prim-white hover:text-prim-brown font-bold">
                Status Pesanan
            </button>
        </div>
    </section>
