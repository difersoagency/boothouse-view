            ...
            <div class=" grid grid-cols-2 items-center">
                <div class="formLogin">
                    ...
                    <form action="" class="mt-10">
                        <input type="text" class="w-80 px-5 rounded-3xl text-prim-brown bg-prim-white border-2 h-12 border-prim-brown" placeholder="Email">
                        <br>
                        <input type="password" class="mt-6 w-80 px-5 rounded-3xl text-prim-brown bg-prim-white border-2 h-12 border-prim-brown" placeholder="Password">
                        <div class="w-80 text-right mt-2">
                            <a href="" class="text-prim-brown underline text-[14px] hover:text-prim-red transition-colors">Lupa Password ?</a>
                        </div>
                        <button class="mt-9 w-80 px-10 py-3 bg-prim-yellow rounded-full hover:bg-prim-red transition-colors hover:text-prim-white text-prim-brown font-bold">
                            Daftar
                        </button>
                        <div class="w-80 text-center mt-2">
