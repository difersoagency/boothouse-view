...
<head>
	...
	<!-- Daterangepicker CSS -->
    <link href="{{asset('vendor/admin/daterangepicker/daterangepicker.css')}}" rel="stylesheet" type="text/css" />

	<!-- Data Table CSS -->
    <link href="{{asset('vendor/admin/datatables.net-bs5/css/dataTables.bootstrap5.min.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{asset('vendor/admin/datatables.net-responsive-bs5/css/responsive.bootstrap5.min.css')}}" rel="stylesheet" type="text/css" />
...
<body>
	...
	<!-- Data Table JS -->
    <script src="{{ asset('vendor/admin/datatables.net/js/jquery.dataTables.min.js')}}"></script>
    <script src="{{ asset('vendor/admin/datatables.net-bs5/js/dataTables.bootstrap5.min.js')}}"></script>
	<script src="{{ asset('vendor/admin/datatables.net-select/js/dataTables.select.min.js')}}"></script>

	<!-- Daterangepicker JS -->
    <script src="{{ asset('vendor/admin/moment/min/moment.min.js')}}"></script>
	...
	<!-- Amcharts Maps JS -->
	<script src="{{ asset('vendor/admin/@amcharts/amcharts4/core.js')}}"></script>
	<script src="{{ asset('vendor/admin/@amcharts/amcharts4/maps.js')}}"></script>
	<script src="{{ asset('vendor/admin/@amcharts/amcharts4-geodata/worldLow.js')}}"></script>
	<script src="{{ asset('vendor/admin/@amcharts/amcharts4-geodata/worldHigh.js')}}"></script>
	<script src="{{ asset('vendor/admin/@amcharts/amcharts4/themes/animated.js')}}"></script>

	<!-- Apex JS -->
	<script src="{{ asset('vendor/admin/apexcharts/dist/apexcharts.min.js')}}"></script>
