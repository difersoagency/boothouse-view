		...
		var provinsitable = $('#provinsitable').DataTable({
			columns: [
				{ data: "nama" },
				{
									...
									render: function(data, type, row) {
										var data = '';
										data += `<button type="button" class="btn btn-outline-info btn-sm" id="edit-modal-provinsi"  data-id=`+row.id+`><i class="fas fa-pencil-alt"></i> Edit</button> `;
										data += `<button type="button" class="btn btn-outline-danger btn-sm" id="hapus_provinsi" data-id=`+row.id+`><i class="fas fa-trash-alt"></i> Hapus</button>`;
										return data;
									}
								}
		...
		var ordertable = $('#ordertable').DataTable({
			columns: [
				...
				
				{
									...
									render: function(data, type, row) {
										var data = '';
										data += `<button type="button" class="btn btn-outline-info btn-sm" id="detail-modal-order" data-inv=`+row.no_order+` data-id=`+row.id+`><i class="fas fa-eye"></i> Detail</button>`;
										return data;
									}
								}
